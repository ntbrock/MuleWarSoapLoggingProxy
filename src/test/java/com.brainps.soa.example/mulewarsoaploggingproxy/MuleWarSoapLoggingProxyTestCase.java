 ...
 * LICENSE.txt file.
 */
package com.brainps.soa.example.mulewarsoaploggingproxy;
...
public class MuleWarSoapLoggingProxyTestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        //TODO You'll need to edit this file to make the test applicable to your module
        return "muleWarSoapLoggingProxy-test-config.xml";
    }

    @Test
    public void muleWarSoapLoggingProxy() throws Exception
    {
